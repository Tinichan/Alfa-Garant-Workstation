...
void __fastcall TForm9::FormActivate(TObject *Sender)
{
	...
	DM->AVTO_KLIENTA_DataSet1->SelectSQL->Add("select * from AVTO_KLIENTA");
...
void __fastcall TForm9::Button5Click(TObject *Sender)
{
	...
	Form10->Caption="Редагування данних";
	Form10->Show();
}
//---------------------------------------------------------------------------
		  ...
		  int DataCol, TColumn *Column, TGridDrawState State)
{
	...
	if(DM->POLIS_DataSet5->FieldByName("STATUS")->AsString == "Чернетка")
	{
		DBGrid1->Canvas->Brush->Color = clSilver;
	}

	if(DM->POLIS_DataSet5->FieldByName("STATUS")->AsString == "Укладений")
	{
		DBGrid1->Canvas->Brush->Color = clLime;
	}

	if(DM->POLIS_DataSet5->FieldByName("STATUS")->AsString == "Дублікат")
	{
		DBGrid1->Canvas->Brush->Color = clAqua;
	}

	if(DM->POLIS_DataSet5->FieldByName("STATUS")->AsString == "Переоформлений")
	{
